...
Revision ID: 6a7decdfb1d9
Revises: 
Create Date: 2023-05-28 15:37:09.160077
...
def upgrade():
    ...
    sa.Column('have_id', sa.Integer(), nullable=False),
    sa.Column('have_date', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('have_id')
    )
